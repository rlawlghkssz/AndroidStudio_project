...
public class Course {
    ...
    public Course(int courseID,
                  String courseGrade, String courseTitle,
                  int courseDivide, int coursePersonnel,
    ...
    public Course(int courseID,
                  ...
                  String courseGrade,
                  String courseTitle,
                  int courseCredit, int courseDivide, int coursePersonnel,
                  String courseProfessor, String courseTime, String courseRoom)
    {
        this.courseID = courseID;
        this.courseUniversity = courseUniversity;
        this.courseYear = courseYear;
